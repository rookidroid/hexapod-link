...
# --- Put it together ---
# Driving the physical robot is not here on purpose: those controls live in the
# global panel (widgets/robot_link_ui.py) so they are reachable from every page.
